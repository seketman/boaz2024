...
---------------------------------------------------*/	
	...
	function FirstLoad() {	
		...
		$('#showcase-slider a.title').on('click', function() {			
			...
			TweenMax.to($(".showcase-captions-wrap.stroked, .header-middle, .title span, .title p"), 0.3, {force3D:true, opacity:0, delay:0, ease:Power2.easeOut});
		...
		$('#showcase-carousel-slider a.title').on('click', function() {
			...
			TweenMax.to($("#showcase-carousel-slider .title span, .title p"), 0.4, {force3D:true, opacity:0, delay:0, ease:Power2.easeOut});
			TweenMax.to($(".arrows-wrap"), 0.2, {force3D:true, opacity:0, delay:0, ease:Power2.easeOut});
			TweenMax.to($(".footer-middle"), 0.2, {force3D:true, opacity:0, delay:0.1, ease:Power2.easeOut});
			TweenMax.to($(".socials-wrap"), 0.2, {force3D:true, opacity:0, delay:0.15, ease:Power2.easeOut});
			TweenMax.to('#ball', 0.3,{borderWidth: '2px', delay:0.3, scale:1, opacity:1});
...
---------------------------------------------------*/
	...
	function QuickMenu() {
		...
		$(".header-middle .button-wrap, .all-projects-wrapper-with-spacer .button-wrap, #close-quickmenu").on('click', function() {

			$(".header-middle .icon-wrap, .all-projects-wrapper-with-spacer .icon-wrap").toggleClass("disabled");			   
			if ($(".header-middle .icon-wrap, .all-projects-wrapper-with-spacer .icon-wrap").hasClass('disabled')) {
				$('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').text($('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').data('off'));
				$('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').attr("data-off", $('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').data('on'));
				$('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').attr("data-on", $('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').text());
				
			} else {
				$('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').text($('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').data('on'));
				$('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').attr("data-on", $('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').data('on'));
				$('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').attr("data-off", $('.all-projects-wrapper-with-spacer .button-text span, .header-middle .button-text span').data('off'));
			}
		});		
				...
				pagination: {
					...
					renderBullet: function (index, className) {
						...
						'<div class="tab__link ' + className + '">' 
							...
							+ '<div class="title">' + titles[index] 
								+ '<span class="counter">' + counter[index] + '</span>' 
								+ `<p class="works-subtitle" style="font-family: 'Poppins', sans-serif; margin-top: -20px; font-size: 14px; color: white; font-weight: 600; line-height: 20px">${subtitle[index] !== 'Video' ? subtitle[index] : ''}</p>`
							+ '</div>' 
						+ '</div>'
						) 
					},
