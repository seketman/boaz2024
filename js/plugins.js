...
function FitQuickScreen() {
  ...
  for (
    var e = document.documentElement,
      ...
      i = document.querySelectorAll(".hover-reveal__img"),
      n = document.querySelectorAll("#quick-projects li"),
      l = 0;
    l < n.length;
    l++
  )
  ...
  function c(e, t, o) {
    o.addEventListener("click", function () {
      TweenMax.to("#ball", 0.2, {
        ...
        $(this).addClass("above"),
        TweenMax.to(".quick-title, .header-middle", 0.4, {
          opacity: 0,
          ease: Power2.easeOut,
        }),
        setTimeout(function () {
      ...
      t.addEventListener("click", function () {
        $("#quick-projects li").removeClass("above"), d(t, e);
      });
  }
  function d(e, o) {
    var i = e.cloneNode(!0),
    ...
    TweenLite.set(i, n), TweenLite.to(i, 1.2, c);
  }
  function a(o) {
    var i = o.getBoundingClientRect(),
      n = window.pageYOffset || e.scrollTop || t.scrollTop || 0,
      l = window.pageXOffset || e.scrollLeft || t.scrollLeft || 0,
      c = e.clientTop || t.clientTop || 0,
      d = e.clientLeft || t.clientLeft || 0;
    return {
      top: Math.round(i.top + n - c),
      left: Math.round(i.left + l - d),
      height: i.height,
      width: i.width,
    };
  }
...
function FitThumbScreen() {
  ...
  for (
    var l = document.documentElement,
      ...
      t = document.querySelectorAll(".item-image"),
      o = 0;
    o < t.length;
    o++
  )
  ...
  function n(e, t) {
    ...
    TweenLite.set([e, t], { visibility: "hidden" }),
      TweenLite.set(o, { position: "absolute", margin: 0 }),
      c.appendChild(o);
    var a = {
      x: n.left - i.left,
      y: n.top - i.top,
  ...
  function o(e, t) {
    e.addEventListener("click", function () {
      TweenMax.to("#ball", 0.2, {
        ...
        TweenMax.to(
          ".swiper-slide .section-image, .swiper-slide .slide-caption, footer",
          0.4,
          { opacity: 0, delay: 0.2, ease: Power2.easeOut }
        ),
        setTimeout(function () {
          n(e, t);
        }, 150),
